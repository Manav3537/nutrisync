...
router.get('/generate-weekly-plan', async (req,res) => {
    ...
    try {
        const response = await axios.get(`https://api.spoonacular.com/mealplanner/generate?timeFrame=week&apiKey=a305445dc5db49bdaf8962d62bf9d257`);
        ...
        for (let dayOffset = 0; dayOffset< 7; dayOffset++) {
            ...
            for (let i = 0; i < meals.length; i++ ) {
                ...
                const image = `https://spoonacular.com/recipeImages/a305445dc5db49bdaf8962d62bf9d257-566x370.${imageType}`;
                ...
                if (existingRecipe.length === 0) {
                    ...
                    const nutritionRes = await axios.get (`https://api.spoonacular.com/recipes/${api_recipe_id}/nutritionWidget.json?apiKey=a305445dc5db49bdaf8962d62bf9d257`);
